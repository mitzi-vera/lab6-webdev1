...
var modelName = document.getElementById("model-text").innerText;
var duration = parseInt(document.getElementById("duration-text").innerText, 10);
...
function changeDuration() {
    ...
    document.getElementById("duration-text").innerText = duration;  // Update display
